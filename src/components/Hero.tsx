    ...
    >
      ...
      <div className="relative z-10 flex flex-col flex-1 w-full pl-[clamp(1rem,4vw,5rem)] pr-[clamp(1rem,8vw,14rem)]">
        ...
        <div className="flex flex-col flex-1 justify-end pb-[clamp(2.5rem,6vw,6rem)]">
          ...
          >
            <span ref={line1Ref} className="block cursor-default select-none">Milind</span>
            <span ref={line2Ref} className="block cursor-default select-none">Verma</span>
          </h1>

          {/* Italic serif tagline */}
          <p
            ref={subRef}
            className="mt-[clamp(1rem,2.5vw,2.5rem)] text-white/70 cursor-default select-none"
            style={{
          ...
          <div className="mt-[clamp(2rem,4vw,4.5rem)] flex flex-col sm:flex-row items-start sm:items-end justify-between gap-8">
            ...
            <div className="flex flex-wrap gap-2">
              {STACK_TAGS.map((tag, i) => (
                <motion.span
                  key={tag}
                  className="border border-white/20 px-3 py-1 text-[0.65rem] font-medium tracking-[0.12em] uppercase text-white/60"
            ...
            <div className="flex items-center gap-4 shrink-0">
              <motion.a
                href="#work"
                data-cursor="view"
                className="group flex items-center gap-2 bg-black text-white border border-white/20 px-6 py-3.5 text-[0.7rem] font-medium tracking-[0.18em] uppercase hover:bg-white/10 hover:border-white/40 transition-colors duration-200"
                style={{ fontFamily: 'Satoshi, system-ui, sans-serif' }}
              ...
              <motion.button
                ...
                className="bg-black text-white px-6 py-3.5 text-[0.7rem] font-medium tracking-[0.18em] uppercase border border-white/20 hover:bg-white/10 hover:border-white/40 transition-colors duration-200"
                style={{ fontFamily: 'Satoshi, system-ui, sans-serif' }}
                initial={{ opacity: 0, y: 12 }}
                animate={{ opacity: 1, y: 0 }}
        ...
        >
          ...
          />
          <span
            className="text-[0.55rem] tracking-[0.22em] uppercase text-white/30"
            style={{ fontFamily: 'Satoshi, system-ui, sans-serif' }}
          >
            Scroll
          </span>
      ...
      <div className="absolute right-[clamp(1rem,2vw,2.5rem)] top-1/2 -translate-y-1/2 hidden lg:flex flex-col items-center gap-3 z-10">
        <span
          ...
          style={{ fontFamily: 'Satoshi, system-ui, sans-serif' }}
        >
          Full Stack · Machine Learning · Remote
        </span>
      </div>
    </section>
  );
