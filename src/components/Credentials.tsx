...
const FLOAT_WORDS = [
  'Certified', 'Networking', '2024', 'Google',
  'Coursera', '2025', 'NPTEL', 'ML',
  'Machine Learning', 'Cisco', 'Devices', 'Academy',
  'Computer', 'B.Tech', 'VIT Bhopal', 'Config',
];
...
function CertRow({
  ...
  return (
    ...
    >
      ...
      <motion.a
        href={cert.file}
        {...(cert.file !== '#' ? { download: true } : { onClick: (e) => e.preventDefault() })}
        style={{ cursor: cert.file === '#' ? 'default' : 'pointer' }}
        ...
        >
          ...
          <div className="relative flex flex-col lg:flex-row lg:items-end justify-between gap-10 lg:gap-16">
            ...
            <div className="flex flex-col gap-5">
              ...
              >
                B.Tech CSE Student — VIT Bhopal · Open to Work
              </motion.p>

              {/* Stack tags */}
              <div className="flex flex-wrap gap-2 mt-1">
                {['React', 'Node.js', 'Python', 'TensorFlow', 'AWS', 'Docker'].map((tag, i) => (
                  <motion.span
                    key={tag}
