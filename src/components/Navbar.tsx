...
const NAV_LINKS = [
  ...
  { label: 'Internship',  href: '#internship',  chevron: false },
...
export function Navbar() {
  ...
  /* Compact ≈ logo(34) + text(~110) + sep + 5 links(~410) + sep + CTA(~90) + padding ≈ 820 */
  const COMPACT_W = 820;
  ...
  return (
    <>
      ...
      <div data-theme="dark" className="fixed top-0 left-0 right-0 z-50 hidden md:block pointer-events-none">
        ...
        >
          {/* Logo — always left */}
          <a href="#" className="flex items-center gap-2.5 shrink-0 mr-3" aria-label="BuildWithMilind">
            <Image
              src="/logo/MILIND VERMA.png"
              alt="BuildWithMilind"
              width={34}
              height={34}
              priority
            ...
            />
            <span 
              className="text-white text-[0.68rem] font-black tracking-[0.14em] uppercase"
              style={{ fontFamily: 'Satoshi, system-ui, sans-serif' }}
            >
              BuildWithMilind
            </span>
      ...
      <div className="fixed top-0 left-0 right-0 z-50 md:hidden pointer-events-none">
        <div className="absolute top-4 left-4 right-4 flex items-center justify-between pointer-events-auto">
          ...
          >
            ...
            />
            <span 
              className="text-white text-[0.62rem] font-black tracking-[0.12em] uppercase pr-1"
              style={{ fontFamily: 'Satoshi, system-ui, sans-serif' }}
            >
              BuildWithMilind
            </span>
